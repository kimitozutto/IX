        ...
        div.innerHTML = `<div class="modal-dialog" role="document">`+
                            `<div class="modal-content">`+
                                ...
                                `<div class="modal-footer">`+
                                    `<button type="button" class="btn btn-secondary" onClick="Alert.closeModel()">${btn.cancle}</button>`+
                                    `<button type="button" class="btn btn-info" id="confirmOk">${btn.submit}</button>`+
                                `</div>`+
                            `</div>`+
                        `</div>`;
        document.body.appendChild(div);
